...
const base = cva(
  [
    'rounded border border-neutral-500 flex items-center justify-center stroke-none',
  ...
  ],
  {
    variants: {
      ...
      color: {
        primary:
          'peer-checked:border-0 peer-checked:bg-primary peer-checked:text-neutral peer-checked:stroke-white',
        secondary:
...
const Checkbox: React.FC<CheckboxProps> = ({
  ...
  <label className="cursor-pointer select-none inline-flex items-center gap-2">
    <input type="checkbox" defaultChecked className="sr-only peer" {...props} />
